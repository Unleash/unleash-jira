...
const FeatureToggleResolver = ({
    ...
    return (<>
        <ConditionallyRender
            condition={found}
            show={<FeatureToggleStatus issueKey={issueKey} toggleName={toggleName} enabled={enabled}/>}
            elseShow={<ConnectToggleActions uiConfig={uiConfig} issueKey={issueKey} setFeature={setFeature}
