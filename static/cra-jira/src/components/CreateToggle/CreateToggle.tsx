...
const CreateToggle = ({
    ...
    const onSubmit = (e: FormEvent) => {
        ...
        invoke<Named>('createFeatureToggle', { toggleData: formData })
            .then((data) => {
                invoke('setToggleName', { toggleName: data.name });
                toggleCreateModal();
                setSuccess(`Successfully created feature toggle ${data.name}`);
            })
            .catch((e) => {
                setError(e.message);
            });
